...
class LoanedBookInstancesByUserListViewTest(TestCase):
    def setUp(self):
        ...
        for book_copy in range(number_of_book_copies):
            return_date = timezone.localtime() + datetime.timedelta(days=book_copy % 5) # Today + 0,1,2,3,4 days
            the_borrower = test_user1 if book_copy % 2 else test_user2 # test_user1/2 if remainder=1/0 ~ book_copy odd/even
            status = 'm'
    ...
    def test_only_borrowed_books_in_list(self):
        ...
        self.assertTrue('bookinstance_list' in response.context)
        # Also verify that we got 5 out of 10 loaned books
...
class RenewBookInstancesViewTest(TestCase):
    def setUp(self):
        ...
        permission = Permission.objects.get(name='Set a book as returned')
    ...
    def test_redirect_if_not_ligged_in(self):
